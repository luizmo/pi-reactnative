...
type Props = {};
export default class questao10 extends Component<Props> {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.alternativas}>
          <TouchableOpacity style={styles.icones} onPress={()=> navigate('resultados', {numero10:this.state.numero10 + 0})}>
                <Image  style={styles.imagem} source={require('../img/atividade10/mm.jpg')} />
          </TouchableOpacity>

          <TouchableOpacity style={styles.icones} onPress={()=> navigate('resultados', {numero10:this.state.numero10 + 1})}>
