...
import questao46 from '.';

class questao45 extends Component{
      ...
      <ImageBackground  source={require('../img/bg_secu.png')} style={[styles.container,{width:"100%", height:"100%"}]}>
        <View style={styles.pergunta}>
          <Text style={styles.texto}>
             Quantos numeros impares a nesta sequencia?
          </Text>
          <Image  source={require('../img/atividades-8-9/quetao45.png')} />
        </View>
        ...
        <View style={styles.alternativas}>
          ...
          <TouchableOpacity style={styles.icones} onPress={()=> navigate('questao46')}>
