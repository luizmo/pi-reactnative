...
class questao36 extends Component{
  ...
  constructor(props){
    ...
    componentWillMount(){
      song = new SoundPlayer('questao36.mp3', SoundPlayer.MAIN_BUNDLE, (error) => {
        if (error)
    ...
    return (
      <ImageBackground onLoad={this.onPressButtonPlay.bind(this)} source={require('../img/bg_secu.png')} style={[styles.container,{width:"100%", height:"100%"}]}>
        ...
        <View style={styles.alternativas}>
          <TouchableOpacity style={styles.icones} onPress={()=> navigate('questao37', {numero36:this.state.numero35 + 0})}>
