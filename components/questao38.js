...
import questao39 from '.';

var SoundPlayer = require('react-native-sound');
var song = null;

class questao38 extends Component{
  static navigationOptions = {
    title:'questao38',
  }
  constructor(props){
    super(props)
    this.state = {numero38:this.props.navigation.state.params.numero37}
  }

  componentWillMount(){
    song = new SoundPlayer('questao38.mp3', SoundPlayer.MAIN_BUNDLE, (error) => {
      if (error)
    ...
    return (
      <ImageBackground onLoad={this.onPressButtonPlay.bind(this)} source={require('../img/bg_secu.png')} style={[styles.container,{width:"100%", height:"100%"}]}>
        ...
        <View style={styles.alternativas}>
          <TouchableOpacity style={styles.icones} onPress={()=> navigate('questao39', {numero38:this.state.numero37 + 1})}>
            <Image  style={styles.imagem} source={require('../img/atividades-3-4/marrom.png')} />
          </TouchableOpacity>

          <TouchableOpacity style={styles.icones} onPress={()=> navigate('questao39', {numero38:this.state.numero37 + 0})}>
        ...
        <View style={styles.alternativas}>
          <TouchableOpacity style={styles.icones} onPress={()=> navigate('questao39', {numero38:this.state.numero37 + 0})}>
            <Image style={styles.imagem} source={require('../img/atividades-3-4/azul_marinho.png')} />
          </TouchableOpacity>
